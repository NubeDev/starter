//! `rubix.warehouse.retention.set` — request/response DTOs and tool descriptor.
//!
...
/// Caller input for `rubix.warehouse.retention.set`.
#[derive(Debug, Clone, Serialize, Deserialize, ToSchema)]
pub struct WarehouseRetentionSetRequest {
...
/// Tool reply.
#[derive(Debug, Clone, Serialize, Deserialize, ToSchema)]
pub struct WarehouseRetentionSetResponse {
    /// Outcome — `rubix.warehouse.retention.set` when the TTL
    /// changed, `rubix.warehouse.retention.unchanged` when the
...
pub static DESCRIPTOR: ToolDescriptor = ToolDescriptor {
    ...
    when_not_to_use: concat!(
        ...
        "rubix.warehouse.mart.create / rubix.warehouse.rule.write). ",
    ...
    example: concat!(
        ...
        "Output: { \"summary\": { \"code\": \"rubix.warehouse.retention.set\", ",
