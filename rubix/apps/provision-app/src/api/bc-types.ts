...
// Reused VERBATIM from the extension's ui-src/provision/bc-types.ts so the
// request/response contracts stay in lockstep with the backend tools.
...
/** Envelope returned by warehouse_query (rows wrapped). */
export interface WarehouseQueryResponse<R> {
