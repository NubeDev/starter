# 04 — Dashboard tool bodies

> **Tier:** scope (plan). Lifetime: weeks. Not referenced from code.
> See [README.md](./README.md). Mirrors the verb-style and
> directory layout of [`rubix-tools/src/flow_ops/`](../../../crates/rubix-tools/src/flow_ops/)
> from PR #32.
