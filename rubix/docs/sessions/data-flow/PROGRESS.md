...
| 7 | [07-ai-authoring.md](./07-ai-authoring.md) — AI via MCP+skills | ⏳ |            |        |                                            |

**Next session: stage 1 (producer) or stage 7 (AI authoring) — both ⏳.**
...
| 07    | Canonical MCP tool-name form (dots vs `mcp__` prefix)   |        |
