...
function HelloPanel() {
  return /* @__PURE__ */ jsx(BlockShell, { children: /* @__PURE__ */ jsx("div", { "data-ext-id": EXTENSION_ID$1, className: "mx-auto flex max-w-3xl flex-col gap-6 p-1", children: /* @__PURE__ */ jsx(PageInner, {}) }) });
}
function PageInner() {
  ...
  const runPing = React.useCallback(() => {
    ...
    }).then((r) => setResult(r)).catch((e) => setError(e instanceof Error ? e.message : String(e))).finally(() => setLoading(false));
  }, [client]);
  React.useEffect(() => {
    runPing();
  }, [runPing]);
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-1", children: [
      ...
      /* @__PURE__ */ jsx("h1", { className: "text-2xl font-semibold tracking-tight", children: "👋 Overview" })
    ] }),
    /* @__PURE__ */ jsxs(Card, { children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsx(CardTitle, { children: "Live ping (contributed kind)" }),
      ...
      /* @__PURE__ */ jsxs(CardContent, { children: [
        error ? /* @__PURE__ */ jsxs("p", { className: "text-sm text-destructive", children: [
          "kind query failed: ",
          error
        ] }) : row ? /* @__PURE__ */ jsxs("dl", { className: "grid grid-cols-[auto_1fr] gap-x-6 gap-y-2 text-sm", children: [
