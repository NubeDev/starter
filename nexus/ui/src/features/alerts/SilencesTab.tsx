...
import { useSilenceMutations, useSilences } from "@/features/alerts/useAlerts";
import { useDateTime } from "@/datetime";
import { Empty } from "@/features/state/Empty";
import { ErrorState } from "@/features/state/ErrorState";
import { Loading } from "@/features/state/Loading";

// Silence windows that mute alerting for a span. A null rule_id mutes all
// rules; here the form creates a global silence (per-rule muting is set
// from a rule's detail). Times are entered as local datetime and sent as
// ISO strings.
  ...
  return (
    <div className="flex h-full flex-col gap-4">
      ...
      {isPending ? (
        ...
        <Empty title="No silences" description="Mute alerting for a window." />
      ) : (
