...
export function FloatingSidebar({ collapsed, onToggleCollapse }: FloatingSidebarProps) {
  const [active, setActive] = useState<string>('#air')
    ...
    >
      <div className="glass hairline relative flex h-full flex-col overflow-hidden rounded-3xl p-3">
        ...
        <div className="flex items-center gap-2.5 rounded-2xl px-2.5 py-2">
          <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[color:var(--color-leaf)] text-[color:var(--color-bg)] shadow-[0_0_20px_rgba(74,222,128,0.4)]">
          ...
          <AnimatePresence initial={false}>
            {!collapsed && (
              ...
              >
                <div className="truncate text-sm font-semibold tracking-tight">Verdant</div>
        ...
        {!collapsed && (
          ...
          >
            ...
            <span className="flex-1">Search rooms, sensors…</span>
