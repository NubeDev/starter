// Vitest-only shim for `react-native-svg`. Renders as host elements
// under jsdom; props (including animated values resolved by tests)
// pass through as data-* attributes.
